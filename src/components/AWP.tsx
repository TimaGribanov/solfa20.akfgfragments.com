...
const Body = () => (
    <div>
        ...
        <p>This time, we are covering <a href='https://akfgfragments.com/song?Loop_%26_Loop'><em>Loop&Loop</em></a> – the song selected in <a href='https://ajikanproject.akfgfragments.com/sol-fa.html'>an open vote</a> by the fans.</p>
        <div id='awp' className='ratio ratio-16x9'>
            <iframe src='https://www.youtube-nocookie.com/embed/_kSjoRU4OHg?si=Z2ZIV4OJexVJHN_u' title='YouTube video player' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' referrerPolicy='strict-origin-when-cross-origin' allowFullScreen></iframe>
        </div>
    </div>
)
